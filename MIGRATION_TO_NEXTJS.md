...
```env
NEXT_PUBLIC_API_URL=https://goapp-7.preview.emergentagent.com/api
```
...
**Backend API URL:** https://goapp-7.preview.emergentagent.com/api
**Current React app:** https://goapp-7.preview.emergentagent.com

...
```env
NEXT_PUBLIC_API_URL=https://fondy-integration.preview.emergentagent.com/api
```
...
**Backend API URL:** https://fondy-integration.preview.emergentagent.com/api
**Current React app:** https://fondy-integration.preview.emergentagent.com
